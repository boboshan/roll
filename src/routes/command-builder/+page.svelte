...
<div class="max-w-3xl mx-a py-4">
	...
	>
		...
		<div class="flex">
			...
			<button type="submit" class="ml-a rounded-2 px-5 py-3 text-sm whitespace-nowrap transition-border-color duration-200 cursor-pointer bg-#f3f3f3 text-#141414 font-500 hover:(bg-background-70 text-#f3f3f3)">Run FFmpeg </button>
		</div>

		<div class="w-full bg-#262626 rounded-1 overflow-hidden my-2 mx-0.5">
			<div
		...
		<div class="bg-#141414 rounded-2 p-4">
